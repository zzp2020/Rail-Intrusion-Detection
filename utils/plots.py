...
class Annotator:
    ...
    def __init__(self, im, line_width=None, font_size=None, font='Arial.ttf', pil=False, example='abc'):
        ...
        if self.pil:  # use PIL
            ...
            self.im = im
        self.lw = line_width or 1  # line width
    ...
    def drawtext(self,color,text):
        font = cv2.FONT_HERSHEY_SIMPLEX
        cv2.rectangle
        blk = np.zeros(self.im.shape, np.uint8)
        cv2.rectangle(blk, (0, 0), (1280,140), (255, 255, 255), -1)
        self.im = cv2.addWeighted(self.im, 1.0, blk, 0.9, 1)
        cv2.putText(self.im, text,(100, 100), font, 3, color, 10)
